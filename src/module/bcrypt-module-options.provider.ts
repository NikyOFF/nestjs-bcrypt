...
export function bcryptModuleOptionsProvider(options: BcryptModuleOptionsInterface) {
  return {
...
export function bcryptModuleAsyncOptionsProvider(options: BcryptModuleAsyncOptionsInterface) {
  return {
    provide: BCRYPT_MODULE_OPTIONS_TOKEN,
